...
//
//    private static final String SECRET_KEY="Ankur336@#225TSR$$KarinSasukeNarutoLuffyZoroSanjiNami336@#$%**WorkingTogetherWithStrawHatCREW";
//    private static final long ACCESSS_TOKEN_EXPIRATION= 15*60*1000;
...
//        long expiration=isAccessToken?ACCESSS_TOKEN_EXPIRATION:REFRESH_TOKEN_EXPIRATION;
//
//        return Jwts.builder()
//                .setSubject(username)
...
public class JwtService {
    ...
    public boolean validateToken(String token) {
        try {
            ...
            System.out.println("Exception in validating token" + e.getMessage() + token);
            return false;
        }
    }
